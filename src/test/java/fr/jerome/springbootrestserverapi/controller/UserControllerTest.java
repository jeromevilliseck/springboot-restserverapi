...
/*
 Cette annotation va aussi apporter toutes les dépendances SpringMVC nécessaires pour le cas de test.
 servira à construire des URL pour générer des requêtes HTTP.
 */
public class UserControllerTest {
    ...
    @MockBean
    /*
    Crée un mock object de la couche de service
     */
    ...
    public void testFindAllUsers() throws Exception {
        ...
        //cette adresse utilise la méthode getAllUsers() qui à été mockée dans la methode setUp() ci-dessus
    ...
    public void testSaveUser() throws Exception {
        ...
        //on commence par retirer l'utilisateur Dupont du mock pour eviter une exception
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/user/users")
                ...
                .andExpect(status().isCreated()); //Pour les differents statuts protocole HTTP, se réferer à HttpStatus.class
